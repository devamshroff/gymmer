...
function buildSystemPrompt(exerciseNames: string[], goalsText?: string | null): string {
  ...
  return [
    ...
    '  ],',
    '  "preWorkoutStretches": [ { "name": string, "duration": string, "timerSeconds": number, "sideCount": 1|2, "videoUrl": string (optional), "tips": string (optional) } ],',
    '  "postWorkoutStretches": [ { "name": string, "duration": string, "timerSeconds": number, "sideCount": 1|2, "videoUrl": string (optional), "tips": string (optional) } ],',
