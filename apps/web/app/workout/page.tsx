  ...
  return (
    ...
    >
      ...
      <main className="relative mx-auto flex min-h-[calc(100vh-96px)] max-w-4xl flex-col items-center justify-center gap-8 px-6 py-16 text-center">
        <div className="absolute right-6 top-6 flex gap-2 home-fade-up" style={{ animationDelay: '120ms' }}>
          <Link
            href="/"
        ...
        >
          ...
          <span
            aria-hidden
            className="mx-auto mt-5 block h-20 w-20 rounded-2xl bg-[url('/icons/gymmer-icon.svg')] bg-cover bg-center shadow-2xl shadow-[#3b207f]/25 sm:h-24 sm:w-24"
          />
