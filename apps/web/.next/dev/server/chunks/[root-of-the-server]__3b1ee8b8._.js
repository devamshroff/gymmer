    ...
    try {
        ...
        for (const file of files){
            ...
            if (workout.name === workoutName) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    workout: withWarmupFlags(workout)
                });
            }
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function loadRoutineFromDatabase(routineId, name) {
    const db = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDatabase"])();
    // Get exercises
                ...
                exercises: [
                    {
                        ...
                        videoUrl: re.video_url || '',
                        tips: re.tips || '',
                        isBodyweight: typeof re.exercise_is_bodyweight === 'number' ? re.exercise_is_bodyweight === 1 : false
                    },
                    {
                        ...
                        tips: re.b2b_tips || '',
                        isBodyweight: typeof re.b2b_partner_is_bodyweight === 'number' ? re.b2b_partner_is_bodyweight === 1 : false
                    }
                ]
            };
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3b1ee8b8._.js.map