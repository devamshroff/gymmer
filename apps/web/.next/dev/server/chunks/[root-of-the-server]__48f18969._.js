...
function buildSystemPrompt(exercises, routineName, routineDescription, exerciseCount) {
    return [
...
async function findOrCreateStretchId(index, stretch, type) {
        ...
        const response = await fetch('https://api.openai.com/v1/chat/completions', {
            ...
            body: JSON.stringify({
                ...
                messages: [
                    {
                        role: 'system',
                        content: buildSystemPrompt(exerciseNames, routine.name, routine.description, exercises.length)
                    },
                    {
                        role: 'user',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__48f18969._.js.map