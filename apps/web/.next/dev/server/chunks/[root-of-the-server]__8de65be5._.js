...
"[project]/lib/metric-utils.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function isPrimaryMetric(value) {
    return Object.values(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"]).includes(value);
}
const PRIMARY_METRIC_NAME_MAP = [
    {
        metric: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].height,
        names: [
            'box jump',
            'box jumps',
            'broad jump',
    ...
    {
        metric: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].time,
        names: [
            'dead hang',
            'dead hangs',
            'plank',
...
function inferPrimaryMetricFromName(name) {
    if (!name) return null;
    const normalized = name.trim().toLowerCase();
    if (!normalized) return null;
    for (const entry of PRIMARY_METRIC_NAME_MAP){
        if (entry.names.some((candidate)=>normalized === candidate || normalized.includes(candidate))) {
            return entry.metric;
        }
    }
    return null;
...
function resolvePrimaryMetric(primaryMetric, isBodyweight) {
    ...
    if (isBodyweight) return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].repsOnly;
    return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].weight;
}
function resolveMetricUnit(primaryMetric, metricUnit, weightUnit, heightUnit) {
    switch(primaryMetric){
        case __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].weight:
            return weightUnit;
        case __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].height:
            return heightUnit;
        case __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].time:
            return metricUnit || 'sec';
        case __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].distance:
            return metricUnit || 'm';
        default:
            return null;
    }
...
function getMetricLabel(primaryMetric, metricUnit, weightUnit, heightUnit, isMachine) {
    ...
    switch(primaryMetric){
        ...
        case __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].repsOnly:
            return 'Reps';
        default:
            return 'Value';
    }
...
function convertMetricFromStorage(value, primaryMetric, weightUnit, heightUnit) {
    if (!Number.isFinite(value)) return 0;
    if (primaryMetric === __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].weight) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$units$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["convertWeightFromStorage"])(value, weightUnit);
    }
    if (primaryMetric === __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].height) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$units$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["convertHeightFromStorage"])(value, heightUnit);
    }
    return value;
}
function convertMetricToStorage(value, primaryMetric, weightUnit, heightUnit) {
    if (!Number.isFinite(value)) return 0;
    if (primaryMetric === __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].weight) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$units$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["convertWeightToStorage"])(value, weightUnit);
    }
    if (primaryMetric === __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].height) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$units$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["convertHeightToStorage"])(value, heightUnit);
    }
    return value;
}
function formatMetricDisplay(value, primaryMetric, metricUnit, weightUnit, heightUnit, isMachine) {
    if (primaryMetric === __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].weight) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$units$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["formatWeightDisplay"])(value, weightUnit, isMachine);
    }
    const resolvedUnit = resolveMetricUnit(primaryMetric, metricUnit, weightUnit, heightUnit);
    const displayValue = convertMetricFromStorage(value, primaryMetric, weightUnit, heightUnit);
    return resolvedUnit ? `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$units$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["formatDisplayNumber"])(displayValue)} ${resolvedUnit}` : (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$units$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["formatDisplayNumber"])(displayValue);
}
function formatMetricInputValue(value, primaryMetric, weightUnit, heightUnit, allowBlank = false) {
    if (allowBlank && value === 0) return '';
    const displayValue = convertMetricFromStorage(value, primaryMetric, weightUnit, heightUnit);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$units$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["formatDisplayNumber"])(displayValue);
}
...
function isRepsOnlyMetric(primaryMetric) {
    return primaryMetric === __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].repsOnly;
}
function isWeightMetric(primaryMetric) {
    return primaryMetric === __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].weight;
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/constants.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$units$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/units.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$metric$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/metric-utils.ts [app-route] (ecmascript)");
...
async function getExerciseHistory(userId, exerciseName, range) {
  ...
  `;
    ...
    const primaryMetric = typeof row?.primary_metric === 'string' ? row.primary_metric : (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$metric$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["inferPrimaryMetricFromName"])(exerciseName) ?? __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].weight;
...
"[project]/app/api/workout/[name]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function withWarmupFlags(workout) {
    const exercises = workout.exercises.map((exercise)=>{
        if (exercise.type === __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_TYPES"].single) {
            ...
            const primaryMetric = exercise.primaryMetric ?? (isBodyweight ? __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].repsOnly : __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].weight);
        ...
        const exercisesWithFlags = exercise.exercises.map((item)=>{
            ...
            const primaryMetric = item.primaryMetric ?? (isBodyweight ? __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].repsOnly : __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].weight);
...
function normalizeStretches(stretches) {
    if (!Array.isArray(stretches)) return [];
    return stretches.map((stretch)=>({
            name: stretch.name,
            timerSeconds: Number.isFinite(Number(stretch.timerSeconds)) && Number(stretch.timerSeconds) > 0 ? Math.round(Number(stretch.timerSeconds)) : 0,
...
async function GET(request, { params }) {
    ...
    try {
        ...
        if (routineIdParam) {
            ...
            if (!isNaN(routineId)) {
                const routine = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRoutineById"])(routineId);
                if (routine) {
                    ...
                    const hasFavorited = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isFavorited"])(user.id, routineId);
        ...
        const routine = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRoutineByName"])(workoutName, user.id);
        if (routine) {
            // Load from database
        ...
        if (favoritedRoutine.rows.length > 0) {
            const routine = favoritedRoutine.rows[0];
            const workout = await loadRoutineFromDatabase(routine.id, workoutName, user.id);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                workout
            });
        ...
        const workoutPlansDir = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', 'workout-plans');
        const files = __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].readdirSync(workoutPlansDir).filter((file)=>file.endsWith('.json'));
        for (const file of files){
            const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(workoutPlansDir, file);
            ...
            if (workout.name === workoutName) {
                ...
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    workout: withWarmupFlags(normalizedWorkout)
                });
            }
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function loadRoutineFromDatabase(routineId, name, userId) {
    const db = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDatabase"])();
    const { restTimeSeconds, supersetRestSeconds } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getUserSettings"])(userId);
    const defaultSets = 3;
    const defaultTargetReps = 10;
    const defaultTargetWeight = 0;
    const defaultWarmupWeight = 0;
    // Get exercises
    const routineExercises = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRoutineExercises"])(routineId);
    const exercises = routineExercises.map((re)=>{
        const isSuperset = Boolean(re.exercise_id2);
        const isBodyweight = typeof re.exercise_is_bodyweight === 'number' ? re.exercise_is_bodyweight === 1 : false;
        const isMachine = typeof re.exercise_is_machine === 'number' ? re.exercise_is_machine === 1 : false;
        const primaryMetric = typeof re.exercise_primary_metric === 'string' ? re.exercise_primary_metric : (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$metric$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["inferPrimaryMetricFromName"])(re.exercise_name) ?? undefined;
        const metricUnit = typeof re.exercise_metric_unit === 'string' ? re.exercise_metric_unit : null;
        if (!isSuperset) {
            return {
                type: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_TYPES"].single,
        ...
        return {
            type: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_TYPES"].b2b,
            ...
            exercises: [
                ...
                },
                {
                    ...
                    isBodyweight: typeof re.exercise2_is_bodyweight === 'number' ? re.exercise2_is_bodyweight === 1 : false,
                    isMachine: typeof re.exercise2_is_machine === 'number' ? re.exercise2_is_machine === 1 : false,
                    primaryMetric: typeof re.exercise2_primary_metric === 'string' ? re.exercise2_primary_metric : (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$metric$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["inferPrimaryMetricFromName"])(re.exercise2_name) ?? undefined,
                    metricUnit: typeof re.exercise2_metric_unit === 'string' ? re.exercise2_metric_unit : null
                }
            ]
        };
    });
    // Get pre-workout stretches
    const preStretches = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRoutineStretches"])(routineId, 'pre');
    const preWorkoutStretches = preStretches.map((s)=>({
            name: s.name,
    ...
    const postStretches = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRoutineStretches"])(routineId, 'post');
    const postWorkoutStretches = postStretches.map((s)=>({
            name: s.name,
            timerSeconds: s.timer_seconds ?? 0,
            videoUrl: s.video_url || '',
            tips: s.tips || ''
    ...
    const cardio = cardioResult.rows[0] ? {
        type: cardioResult.rows[0].cardio_type,
        duration: cardioResult.rows[0].duration,
        intensity: cardioResult.rows[0].intensity || '',
        tips: cardioResult.rows[0].tips || ''
    } : undefined;
    return {
        ...withWarmupFlags({
            name,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8de65be5._.js.map