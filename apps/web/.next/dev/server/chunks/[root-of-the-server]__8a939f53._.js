...
"[project]/app/api/workout-report/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    ...
    try {
        ...
        const preWorkoutTargetsRaw = body?.preWorkoutTargets;
        ...
        for (const name of exerciseNames){
            const logs = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRecentExerciseLogs"])(name, user.id, 3);
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateWorkoutSessionReport"])({
            userId: user.id,
...
async function GET(request) {
    ...
    try {
        ...
        if (Number.isFinite(sessionId)) {
            report = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getWorkoutSessionReportById"])(user.id, sessionId);
        }
        if (!report && sessionKey) {
            report = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getWorkoutSessionReportByKey"])(user.id, sessionKey);
        }
        if (!report && workoutName) {
            report = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getLatestWorkoutReportForWorkoutName"])(user.id, workoutName);
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            report: report || null
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8a939f53._.js.map