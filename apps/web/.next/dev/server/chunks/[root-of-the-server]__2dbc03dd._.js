...
async function generateExerciseInsights(data) {
    ...
    try {
                ...
                messages: [
                    {
                        ...
                        content: [
                            ...
                            `exerciseTypes must be 1-2 items from: ${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$muscle$2d$tags$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_TYPE_TAGS"].join(', ')}.`,
        ...
        const exerciseTypes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$muscle$2d$tags$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeTypeList"])(parsed.exerciseTypes, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$muscle$2d$tags$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_TYPE_TAGS"]);
        return {
...
"[project]/app/api/stretches/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    try {
        const stretches = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAllStretches"])();
...
async function POST(request) {
    ...
    try {
        ...
        const muscleGroupsInput = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$muscle$2d$tags$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeTypeList"])(body.muscleGroups || body.stretchTypes, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$muscle$2d$tags$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["STRETCH_MUSCLE_TAGS"]);
        ...
        const timerSecondsInput = Number.isFinite(Number(timerSeconds)) && Number(timerSeconds) > 0 ? Number(timerSeconds) : Number.isFinite(durationSecondsRaw) && durationSecondsRaw > 0 ? durationSecondsRaw : NaN;
        const timerSecondsValue = Number.isFinite(timerSecondsInput) && timerSecondsInput > 0 ? Math.round(timerSecondsInput) : insights?.timerSeconds ?? null;
        const sideCountValue = Number(sideCount) === 1 || Number(sideCount) === 2 ? Number(sideCount) : insights?.sideCount ?? 1;
        const inferredMuscleGroups = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$muscle$2d$tags$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeTypeList"])(insights?.muscleGroups, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$muscle$2d$tags$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["STRETCH_MUSCLE_TAGS"]);
        ...
        const stretchId = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createStretch"])({
            name: nameValue,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2dbc03dd._.js.map