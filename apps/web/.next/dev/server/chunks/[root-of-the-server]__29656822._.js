...
"[project]/app/api/report-bug/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
[__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
...
async function POST(request) {
    ...
    if (!resendApiKey || !fromEmail || !toEmail) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/report-bug?status=error', request.url), 303);
    }
    let formData;
    try {
    ...
    if (screenshot instanceof File && screenshot.size > 0) {
        if (!ALLOWED_SCREENSHOT_TYPES.has(screenshot.type) || screenshot.size > MAX_SCREENSHOT_BYTES) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/report-bug?status=invalid-file', request.url), 303);
        }
    ...
    const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCurrentUser"])();
    const referer = request.headers.get('referer') || 'Unknown';
    const userAgent = request.headers.get('user-agent') || 'Unknown';
    const reporterLine = user ? `${user.name ? `${user.name} ` : ''}<${user.email}>` : 'Anonymous user';
  ...
  `;
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/report-bug?status=sent', request.url), 303);
}
__turbopack_async_result__();
} catch(e) { __turbopack_async_result__(e); } }, false);}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__29656822._.js.map