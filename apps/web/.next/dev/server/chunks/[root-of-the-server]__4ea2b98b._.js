...
"[project]/lib/constants.ts [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/units.ts [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/metric-utils.ts [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/constants.ts [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$units$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/units.ts [middleware] (ecmascript)");
;
;
function isPrimaryMetric(value) {
    return Object.values(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"]).includes(value);
}
function resolvePrimaryMetric(primaryMetric, isBodyweight) {
    if (isPrimaryMetric(primaryMetric)) return primaryMetric;
    if (isBodyweight) return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].repsOnly;
    return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].weight;
}
function resolveMetricUnit(primaryMetric, metricUnit, weightUnit, heightUnit) {
    switch(primaryMetric){
        case __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].weight:
            return weightUnit;
        case __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].height:
            return heightUnit;
        case __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].time:
            return metricUnit || 'sec';
        case __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].distance:
            return metricUnit || 'm';
        default:
            return null;
    }
...
function getMetricLabel(primaryMetric, metricUnit, weightUnit, heightUnit, isMachine) {
    ...
    switch(primaryMetric){
        ...
        case __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].repsOnly:
            return 'Reps';
        default:
            return 'Value';
    }
...
function convertMetricFromStorage(value, primaryMetric, weightUnit, heightUnit) {
    if (!Number.isFinite(value)) return 0;
    if (primaryMetric === __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].weight) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$units$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["convertWeightFromStorage"])(value, weightUnit);
    }
    if (primaryMetric === __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].height) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$units$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["convertHeightFromStorage"])(value, heightUnit);
    }
    return value;
}
function convertMetricToStorage(value, primaryMetric, weightUnit, heightUnit) {
    if (!Number.isFinite(value)) return 0;
    if (primaryMetric === __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].weight) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$units$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["convertWeightToStorage"])(value, weightUnit);
    }
    if (primaryMetric === __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].height) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$units$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["convertHeightToStorage"])(value, heightUnit);
    }
    return value;
}
function formatMetricDisplay(value, primaryMetric, metricUnit, weightUnit, heightUnit, isMachine) {
    if (primaryMetric === __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].weight) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$units$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["formatWeightDisplay"])(value, weightUnit, isMachine);
    }
    const resolvedUnit = resolveMetricUnit(primaryMetric, metricUnit, weightUnit, heightUnit);
    const displayValue = convertMetricFromStorage(value, primaryMetric, weightUnit, heightUnit);
    return resolvedUnit ? `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$units$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["formatDisplayNumber"])(displayValue)} ${resolvedUnit}` : (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$units$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["formatDisplayNumber"])(displayValue);
}
function formatMetricInputValue(value, primaryMetric, weightUnit, heightUnit, allowBlank = false) {
    if (allowBlank && value === 0) return '';
    const displayValue = convertMetricFromStorage(value, primaryMetric, weightUnit, heightUnit);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$units$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["formatDisplayNumber"])(displayValue);
}
...
function isRepsOnlyMetric(primaryMetric) {
    return primaryMetric === __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].repsOnly;
}
function isWeightMetric(primaryMetric) {
    return primaryMetric === __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].weight;
}
}),
"[project]/lib/database.ts [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/constants.ts [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$units$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/units.ts [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$metric$2d$utils$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/metric-utils.ts [middleware] (ecmascript)");
...
async function getUserSettings(userId) {
    ...
    const weightUnit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$units$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["normalizeWeightUnit"])(row?.weight_unit);
    const heightUnit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$units$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["normalizeHeightUnit"])(row?.height_unit);
    return {
...
async function getExerciseHistory(userId, exerciseName, range) {
  ...
  `;
    ...
    const primaryMetric = typeof row?.primary_metric === 'string' ? row.primary_metric : (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$metric$2d$utils$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["inferPrimaryMetricFromName"])(exerciseName) ?? __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].weight;
    const metricUnit = typeof row?.metric_unit === 'string' ? row.metric_unit : null;
    const displayMode = primaryMetric === __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].repsOnly || isBodyweight ? __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["EXERCISE_HISTORY_DISPLAY_MODES"].reps : __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["EXERCISE_HISTORY_DISPLAY_MODES"].weight;
    const normalizedPoints = primaryMetric === __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].weight ? points : points.map((point)=>({
            ...point,
            volume: null
        }));
    return {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/database.ts [middleware] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
const { handlers, signIn, signOut, auth } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])({
    ...
    callbacks: {
        async signIn ({ user }) {
            ...
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["upsertUser"])({
                    id: user.email,
                    email: user.email,
                    name: user.name || null,
...
;
;
const __TURBOPACK__default__export__ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$auth$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["auth"])((req)=>{
    ...
    if (isLoginPage && isLoggedIn) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/", req.url));
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4ea2b98b._.js.map