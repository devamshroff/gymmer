...
async function POST(request) {
    ...
    try {
        ...
        const timerSecondsInput = Number.isFinite(Number(timerSeconds)) && Number(timerSeconds) > 0 ? Math.round(Number(timerSeconds)) : null;
        ...
        const timerSecondsValue = timerSecondsInput ? Math.round(timerSecondsInput) : insights?.timerSeconds ?? null;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3b360c55._.js.map