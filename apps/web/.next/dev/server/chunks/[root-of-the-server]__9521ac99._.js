...
async function getExerciseHistory(userId, exerciseName, range) {
  ...
  `;
    ...
    const displayMode = isBodyweight ? 'reps' : undefined;
    return {
                ...
                messages: [
                    {
                        ...
                        content: [
                            ...
                            'Return JSON only: {"tips":"...","isBodyweight":true|false}.',
...
async function GET(request) {
    ...
    try {
        ...
        const stretches = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAllStretches"])(type || undefined);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9521ac99._.js.map