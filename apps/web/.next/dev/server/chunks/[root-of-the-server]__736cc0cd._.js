...
"[project]/app/api/routines/ai-generate/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function buildSystemPrompt(exerciseNames, goalsText) {
...
async function POST(request) {
    ...
    try {
        ...
        const allExercises = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAllExercises"])();
        ...
        const response = await fetch('https://api.openai.com/v1/chat/completions', {
            ...
            body: JSON.stringify({
                ...
                messages: [
                    {
                        role: 'system',
                        content: buildSystemPrompt(exerciseNames, goalsText)
                    },
                    {
                        role: 'user',
                        content: prompt
...
//# sourceMappingURL=%5Broot-of-the-server%5D__736cc0cd._.js.map