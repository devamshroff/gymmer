...
function collectExerciseNames(workout) {
    const names = new Set();
...
function computeWorkoutChecksum(workout) {
    const payload = JSON.stringify(workout);
    return (0, __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["createHash"])('sha256').update(payload).digest('hex');
}
async function GET(request, { params }) {
    ...
    try {
        ...
        const buildResponse = async (workout, routineMeta)=>{
            if (!isBootstrap) {
            ...
            const lastSetEntries = await Promise.all(exerciseNames.map(async (exerciseName)=>[
                    exerciseName,
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getLastExerciseLog"])(exerciseName, user.id)
                ]));
            const lastSetSummaries = Object.fromEntries(lastSetEntries);
            const lastWorkoutReport = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getLatestWorkoutReportForWorkoutName"])(user.id, workout.name);
...
async function loadRoutineFromDatabase(routineId, name, userId) {
    ...
    const exercises = routineExercises.map((re)=>{
        ...
        const primaryMetric = typeof re.exercise_primary_metric === 'string' ? re.exercise_primary_metric : undefined;
        ...
        return {
            ...
            exercises: [
                ...
                },
                {
                    ...
                    primaryMetric: typeof re.exercise2_primary_metric === 'string' ? re.exercise2_primary_metric : undefined,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7da830ac._.js.map