...
"[project]/app/api/workout-autosave/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    ...
    try {
        ...
        const sessionMode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$workout$2d$session$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["resolveSessionMode"])(body.sessionMode, 'incremental');
        ...
        let session = sessionId ? await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getWorkoutSessionById"])(sessionId, user.id) : null;
        if (!session && sessionKey) {
            const existingByKey = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getWorkoutSessionByKey"])(user.id, sessionKey);
            if (existingByKey) {
        ...
        if (!session) {
            ...
            try {
                sessionId = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createWorkoutSession"])({
                    user_id: user.id,
            ...
            if (sessionId !== null) {
                session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getWorkoutSessionById"])(sessionId, user.id);
            }
        }
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["touchWorkoutSession"])(sessionId, user.id, {
            routine_id: routineId,
        ...
        if (event?.type === 'single_set') {
            ...
            if (event.isWarmup) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["upsertWorkoutExerciseLog"])({
                    session_id: sessionId,
                    exercise_name: event.exerciseName,
                    exercise_type: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_TYPES"].single,
        ...
        if (event?.type === 'b2b_set') {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["upsertWorkoutExerciseLog"])({
                session_id: sessionId,
                exercise_name: event.exerciseName,
                exercise_type: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_TYPES"].b2b,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Failed to autosave workout'
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__62afe0eb._.js.map