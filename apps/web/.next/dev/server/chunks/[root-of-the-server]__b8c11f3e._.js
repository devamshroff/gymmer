...
async function getExerciseHistory(userId, exerciseName, range) {
  ...
  `;
    ...
    const displayMode = isBodyweight ? __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_HISTORY_DISPLAY_MODES"].reps : __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_HISTORY_DISPLAY_MODES"].weight;
    return {
...
"[project]/lib/muscle-tags.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    ...
    "generateFormTips",
    ()=>generateFormTips,
    "generateStretchInsights",
    ()=>generateStretchInsights
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$muscle$2d$tags$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/muscle-tags.ts [app-route] (ecmascript)");
;
...
async function generateExerciseInsights(data) {
    ...
    try {
                ...
                messages: [
                    {
                        ...
                        content: [
                            ...
                            `muscleGroups must be 1-2 items from: ${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$muscle$2d$tags$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MUSCLE_GROUP_TAGS"].join(', ')}.`,
        ...
        const muscleGroups = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$muscle$2d$tags$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeTypeList"])(parsed.muscleGroups ?? parsed.exerciseTypes, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$muscle$2d$tags$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MUSCLE_GROUP_TAGS"]);
...
async function generateStretchInsights(data) {
    if (!process.env.OPENAI_API_KEY) {
        return null;
    }
    try {
                ...
                messages: [
                    {
                        ...
                        content: [
                            ...
                            `muscleGroups must be 1-2 items from: ${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$muscle$2d$tags$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["STRETCH_MUSCLE_TAGS"].join(', ')}.`,
                            'Use "unknown" if the muscle group is unclear.',
        ...
        const timerSeconds = Number.isFinite(timerSecondsRaw) && timerSecondsRaw > 0 ? Math.round(timerSecondsRaw) : null;
        const muscleGroups = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$muscle$2d$tags$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeTypeList"])(parsed.muscleGroups ?? parsed.stretchTypes, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$muscle$2d$tags$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["STRETCH_MUSCLE_TAGS"]);
        return {
            tips: tips && tips.length > 0 ? tips : null,
            timerSeconds,
            muscleGroups: muscleGroups.length > 0 ? muscleGroups : null
...
"[project]/app/api/routines/[id]/stretch-recommendations/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function buildRecommendationSignature(payload) {
    return (0, __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["createHash"])('sha256').update(JSON.stringify(payload)).digest('hex');
}
function buildSystemPrompt(exercises, routineName, routineDescription, exerciseCount, availableStretchNames, goalsText) {
    ...
    return [
        ...
        availableStretchNames?.length ? `Available stretches: ${availableStretchNames.join(', ')}` : 'Available stretches: (none)',
        'Prefer existing stretches from the lists above when possible. If a needed stretch is missing, suggest a new one.',
        goalsLine,
        `Exercises: ${exercises.join(', ')}`
    ].join('\n');
}
async function buildNameIndex(stretches) {
...
async function findOrCreateStretchId(index, stretch, goalsText) {
    ...
    const providedTimer = Number.isFinite(Number(stretch.timerSeconds)) && Number(stretch.timerSeconds) > 0 ? Math.round(Number(stretch.timerSeconds)) : null;
    const muscleGroupsInput = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$muscle$2d$tags$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeTypeList"])(stretch.muscleGroups || stretch.stretchTypes, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$muscle$2d$tags$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["STRETCH_MUSCLE_TAGS"]);
    ...
    if (!resolvedTimerSeconds || !resolvedTips) {
        const insights = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$form$2d$tips$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateStretchInsights"])({
            kind: 'stretch',
            name,
        ...
        if (muscleGroups.length === 0) {
            muscleGroups = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$muscle$2d$tags$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeTypeList"])(insights?.muscleGroups, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$muscle$2d$tags$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["STRETCH_MUSCLE_TAGS"]);
        }
    }
    if (!resolvedTimerSeconds) {
        throw new Error(`Missing timerSeconds for stretch "${name}"`);
    }
    const resolvedMuscleGroups = muscleGroups.length ? muscleGroups : [
        'unknown'
    ];
    const id = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createStretch"])({
        name,
...
async function POST(request, { params }) {
    ...
    try {
        ...
        const exercises = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRoutineExercises"])(routineId);
        ...
        const stretchVersion = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getStretchVersion"])();
        ...
        const cached = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRoutineStretchRecommendationCache"])({
            routineId,
            userId: user.id,
            signature
        });
        ...
        const allStretches = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAllStretches"])();
        ...
        const response = await fetch('https://api.openai.com/v1/chat/completions', {
            ...
            body: JSON.stringify({
                ...
                messages: [
                    {
                        role: 'system',
                        content: buildSystemPrompt(exerciseNames, routine.name, routine.description, exercises.length, availableStretchNames, goalsText)
                    },
                    {
                        role: 'user',
                        content: 'Recommend stretches for this routine.'
                    }
                ],
                temperature: 0.4
            })
        ...
        const preList = Array.isArray(recommendations.preWorkoutStretches) ? recommendations.preWorkoutStretches : [];
        const postList = Array.isArray(recommendations.postWorkoutStretches) ? recommendations.postWorkoutStretches : [];
        const minCount = exercises.length >= 9 ? 7 : exercises.length >= 5 ? 5 : 4;
        const index = await buildNameIndex(allStretches);
        const createdIds = [];
        const recommendedPreIds = [];
        ...
        const fillMissing = (ids)=>{
            if (ids.length >= minCount) return ids;
            const existingIds = new Set(ids);
            const candidates = allStretches.filter((stretch)=>!existingIds.has(stretch.id)).map((stretch)=>stretch.id);
        ...
        const updatedStretches = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAllStretches"])();
        const createdStretches = updatedStretches.filter((s)=>createdIds.includes(s.id));
        const finalStretchVersion = createdIds.length > 0 ? await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getStretchVersion"])() : stretchVersion;
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["upsertRoutineStretchRecommendationCache"])({
            routineId,
            userId: user.id,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b8c11f3e._.js.map