...
async function updateRoutineName(id, newName) {
    const db = getDatabase();
...
async function GET(request, { params }) {
    try {
        ...
        const routine = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRoutineByName"])(workoutName);
        if (routine) {
            // Load from database
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ab1d8b0d._.js.map