...
async function POST(request) {
    ...
    try {
        ...
        const routineIdCandidate = typeof sessionData.routineId === 'number' ? sessionData.routineId : Number(sessionData.routineId);
        const routineId = Number.isFinite(routineIdCandidate) ? routineIdCandidate : null;
        const sessionIdCandidate = typeof sessionData.sessionId === 'number' ? sessionData.sessionId : Number(sessionData.sessionId);
        ...
        if (activeSessionId !== null) {
            const existing = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getWorkoutSessionById"])(activeSessionId, user.id);
            if (!existing) {
                activeSessionId = null;
            }
        }
        if (activeSessionId === null) {
            activeSessionId = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createWorkoutSession"])({
                user_id: user.id,
                ...
                session_mode: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$workout$2d$session$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["resolveSessionMode"])(sessionData.sessionMode, 'incremental')
            });
        } else {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateWorkoutSession"])(activeSessionId, user.id, {
                routine_id: routineId,
                workout_plan_name: workoutName,
                date_completed: endTime.toISOString(),
                total_duration_minutes: totalDurationMinutes,
        ...
        for (const exercise of sessionData.exercises){
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["upsertWorkoutExerciseLog"])(exerciseLog);
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f0337779._.js.map