...
"[project]/lib/workout-session.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function isSessionMode(value) {
    return value === __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SESSION_MODES"].progress || value === __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SESSION_MODES"].maintenance || value === __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SESSION_MODES"].light;
}
function resolveSessionMode(value, fallback = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SESSION_MODES"].progress) {
...
"[project]/app/api/workout-targets/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/database.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$workout$2d$session$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/workout-session.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/constants.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    ...
    return logs.map((log)=>{
        ...
        return {
            ...
            warmup: log.warmup_weight !== null && log.warmup_reps !== null ? {
                weight: log.warmup_weight,
                reps: log.warmup_reps
            } : null,
            sets
        };
    });
}
function getLogMaxes(sets) {
    let maxWeight = null;
    let maxReps = null;
...
function summarizeHistoryTrends(history) {
    const summary = {};
    for (const [name, logs] of Object.entries(history)){
        const latest = logs[0] ? getLogMaxes(logs[0].sets) : {
            maxWeight: null,
            maxReps: null
        };
        const previous = logs[1] ? getLogMaxes(logs[1].sets) : {
            maxWeight: null,
            maxReps: null
        };
        summary[name] = {
...
function normalizeSummaryField(value) {
    if (typeof value !== 'string') return null;
    const trimmed = value.trim();
    return trimmed.length > 0 ? trimmed : null;
}
function normalizeResponse(raw, exerciseNames, machineAddedWeight, exerciseMetrics) {
    ...
    for (const entry of raw.targets){
        ...
        if (exerciseMetrics.get(entry.name) === __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].weight && machineAddedWeight.get(entry.name) === false) {
...
async function POST(request) {
    ...
    try {
        ...
        const sessionMode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$workout$2d$session$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["resolveSessionMode"])(body?.sessionMode);
        ...
        const lastWorkoutReport = workoutName ? await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getLatestWorkoutReportForWorkoutName"])(user.id, workoutName) : null;
        const exerciseNames = new Set();
        const exerciseMetrics = new Map();
        for (const exercise of exercises){
            if (exercise?.name) {
                exerciseNames.add(String(exercise.name));
                const primaryMetric = exercise.primaryMetric ?? (exercise.isBodyweight ? __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].repsOnly : __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].weight);
                exerciseMetrics.set(String(exercise.name), primaryMetric);
            }
        }
        const history = {};
        for (const name of exerciseNames){
            const logs = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRecentExerciseLogs"])(name, user.id, 4);
        ...
        const machineAddedWeight = new Map();
        for (const exercise of exercises){
            if (!exercise.isMachine) continue;
            const primaryMetric = exercise.primaryMetric ?? (exercise.isBodyweight ? __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].repsOnly : __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].weight);
            if (primaryMetric !== __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EXERCISE_PRIMARY_METRICS"].weight) continue;
            const logs = history[exercise.name] || [];
            const hasAdded = logs.some((log)=>log.sets.some((set)=>set.weight > 0));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c36dacbe._.js.map