(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/node_modules_c17ec2c3._.js",
...
"[project]/node_modules/@libsql/core/lib-esm/api.js [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class LibsqlError extends Error {
    ...
    /** Extended error code with more specific information (e.g., SQLITE_CONSTRAINT_PRIMARYKEY). */ extendedCode;
...
class LibsqlBatchError extends LibsqlError {
    /** The zero-based index of the statement that failed in the batch. */ statementIndex;
...
"[project]/node_modules/@libsql/core/lib-esm/uri.js [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
// `file` scheme.
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$api$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@libsql/core/lib-esm/api.js [middleware-edge] (ecmascript)");
;
function parseUri(text) {
    const match = URI_RE.exec(text);
    if (match === null) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$api$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LibsqlError"](`The URL '${text}' is not in a valid format`, "URL_INVALID");
    }
...
function parseAuthority(text) {
    ...
    if (match === null) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$api$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LibsqlError"]("The authority part of the URL is not in a valid format", "URL_INVALID");
    }
    const groups = match.groups;
...
function percentDecode(text) {
    try {
        ...
        if (e instanceof URIError) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$api$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LibsqlError"](`URL component has invalid percent encoding: ${e}`, "URL_INVALID", undefined, undefined, e);
        }
        throw e;
    }
}
function encodeBaseUrl(scheme, authority, path) {
    if (authority === undefined) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$api$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LibsqlError"](`URL with scheme ${JSON.stringify(scheme + ":")} requires authority (the "//" part)`, "URL_INVALID");
    }
...
"[project]/node_modules/@libsql/core/lib-esm/util.js [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@libsql/core/lib-esm/config.js [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$api$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@libsql/core/lib-esm/api.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$uri$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@libsql/core/lib-esm/uri.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$util$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@libsql/core/lib-esm/util.js [middleware-edge] (ecmascript)");
;
;
;
...
function expandConfig(config, preferHttp) {
    ...
    const uri = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$uri$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["parseUri"])(url);
    ...
    for (const { key, value } of uri.query?.pairs ?? []){
        if (!Object.hasOwn(queryParamsDef, key)) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$api$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LibsqlError"](`Unsupported URL query parameter ${JSON.stringify(key)}`, "URL_PARAM_NOT_SUPPORTED");
        }
        const queryParamDef = queryParamsDef[key];
        if (queryParamDef.values !== undefined && !queryParamDef.values.includes(value)) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$api$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LibsqlError"](`Unknown value for the "${key}" query argument: ${JSON.stringify(value)}. Supported values are: [${queryParamDef.values.map((x)=>'"' + x + '"').join(", ")}]`, "URL_INVALID");
        }
    ...
    if (originalUriScheme === "libsql") {
        if (tls === false) {
            if (uri.authority?.port === undefined) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$api$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LibsqlError"]('A "libsql:" URL with ?tls=0 must specify an explicit port', "URL_INVALID");
            }
    ...
    if (scheme !== "http" && scheme !== "ws" && scheme !== "https" && scheme !== "wss" && scheme !== "file") {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$api$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LibsqlError"]('The client supports only "libsql:", "wss:", "ws:", "https:", "http:" and "file:" URLs, ' + `got ${JSON.stringify(uri.scheme + ":")}. ` + `For more information, please read ${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$util$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["supportedUrlLink"]}`, "URL_SCHEME_NOT_SUPPORTED");
    }
    if (intMode !== "number" && intMode !== "bigint" && intMode !== "string") {
        throw new TypeError(`Invalid value for intMode, expected "number", "bigint" or "string", got ${JSON.stringify(intMode)}`);
    }
    if (uri.fragment !== undefined) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$api$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LibsqlError"](`URL fragments are not supported: ${JSON.stringify("#" + uri.fragment)}`, "URL_INVALID");
    }
    if (isInMemoryMode) {
        return {
            scheme: "file",
...
"[project]/node_modules/cross-fetch/dist/browser-ponyfill.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
class HranaTransaction {
    ...
    async batch(stmts) {
        ...
        if (stream.closed) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$api$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LibsqlError"]("Cannot execute statements because the transaction is closed", "TRANSACTION_CLOSED");
        }
        try {
            ...
            if (this.#started === undefined) {
                ...
                const beginPromise = beginStep.run((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$util$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["transactionModeToBegin"])(this.#mode));
            ...
            for(let i = 0; i < rowsPromises.length; i++){
                try {
                    ...
                    if (rows === undefined) {
                        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$api$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LibsqlBatchError"]("Statement in a transaction was not executed, " + "probably because the transaction has been rolled back", i, "TRANSACTION_CLOSED");
                    }
                    resultSets.push(resultSetFromHrana(rows));
                } catch (e) {
                    if (e instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$api$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LibsqlBatchError"]) {
                        throw e;
                    }
                    // Map hrana errors to LibsqlError first, then wrap in LibsqlBatchError
                    const mappedError = mapHranaError(e);
                    if (mappedError instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$api$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LibsqlError"]) {
                        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$api$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LibsqlBatchError"](mappedError.message, i, mappedError.code, mappedError.extendedCode, mappedError.rawCode, mappedError.cause instanceof Error ? mappedError.cause : undefined);
                    }
                    throw mappedError;
                }
            }
    ...
    async executeMultiple(sql) {
        ...
        try {
            if (this.#started === undefined) {
                ...
                this.#started = stream.run((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$util$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["transactionModeToBegin"])(this.#mode)).then(()=>undefined);
                try {
                    await this.#started;
                } catch (e) {
                    this.close();
    ...
    async commit() {
        ...
        try {
            const stream = this._getStream();
            if (stream.closed) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$api$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LibsqlError"]("Cannot commit the transaction because it is already closed", "TRANSACTION_CLOSED");
            }
            if (this.#started !== undefined) {
...
async function executeHranaBatch(mode, version, batch, hranaStmts, disableForeignKeys = false) {
    ...
    const beginStep = batch.step();
    const beginPromise = beginStep.run((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$util$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["transactionModeToBegin"])(mode));
    let lastStep = beginStep;
    ...
    for(let i = 0; i < stmtPromises.length; i++){
        try {
            ...
            if (hranaRows === undefined) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$api$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LibsqlBatchError"]("Statement in a batch was not executed, probably because the transaction has been rolled back", i, "TRANSACTION_CLOSED");
            }
...
function stmtToHrana(stmt) {
    ...
    const hranaStmt = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$hrana$2d$client$2f$lib$2d$esm$2f$stmt$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["Stmt"](sql);
    if (args) {
...
function resultSetFromHrana(hranaRows) {
    ...
    return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$util$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["ResultSetImpl"](columns, columnTypes, rows, rowsAffected, lastInsertRowid);
}
function mapHranaError(e) {
    if (e instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$hrana$2d$client$2f$lib$2d$esm$2f$errors$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["ClientError"]) {
        ...
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$api$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LibsqlError"](e.message, code, undefined, undefined, e);
    }
    return e;
}
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$hrana$2d$client$2f$lib$2d$esm$2f$errors$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@libsql/hrana-client/lib-esm/errors.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$api$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@libsql/core/lib-esm/api.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$config$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@libsql/core/lib-esm/config.js [middleware-edge] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$uri$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@libsql/core/lib-esm/uri.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$util$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@libsql/core/lib-esm/util.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$promise$2d$limit$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/promise-limit/index.js [middleware-edge] (ecmascript)");
;
;
;
;
...
function createClient(config) {
    return _createClient((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$config$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["expandConfig"])(config, false));
}
function _createClient(config) {
    if (config.scheme !== "wss" && config.scheme !== "ws") {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$api$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LibsqlError"]('The WebSocket client supports only "libsql:", "wss:" and "ws:" URLs, ' + `got ${JSON.stringify(config.scheme + ":")}. For more information, please read ${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$util$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["supportedUrlLink"]}`, "URL_SCHEME_NOT_SUPPORTED");
    }
    if (config.encryptionKey !== undefined) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$api$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LibsqlError"]("Encryption key is not supported by the remote client.", "ENCRYPTION_KEY_NOT_SUPPORTED");
    }
    if (config.scheme === "ws" && config.tls) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$api$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LibsqlError"](`A "ws:" URL cannot opt into TLS by using ?tls=1`, "URL_INVALID");
    } else if (config.scheme === "wss" && !config.tls) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$api$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LibsqlError"](`A "wss:" URL cannot opt out of TLS by using ?tls=0`, "URL_INVALID");
    }
    const url = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$uri$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["encodeBaseUrl"])(config.scheme, config.authority, config.path);
    let client;
    try {
        client = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$hrana$2d$client$2f$lib$2d$esm$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["openWs"](url, config.authToken);
    } catch (e) {
        if (e instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$hrana$2d$client$2f$lib$2d$esm$2f$errors$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["WebSocketUnsupportedError"]) {
            ...
            const suggestedUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$uri$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["encodeBaseUrl"])(suggestedScheme, config.authority, config.path);
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$api$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LibsqlError"]("This environment does not support WebSockets, please switch to the HTTP client by using " + `a "${suggestedScheme}:" URL (${JSON.stringify(suggestedUrl)}). ` + `For more information, please read ${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$util$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["supportedUrlLink"]}`, "WEBSOCKETS_NOT_SUPPORTED");
        }
...
class WsClient {
    ...
    /** @private */ constructor(client, url, authToken, intMode, concurrency){
        ...
        this.closed = false;
        this.protocol = "ws";
        this.#promiseLimitFunction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$promise$2d$limit$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"])(concurrency);
    }
    async limit(fn) {
    ...
    async execute(stmtOrSql, args) {
        ...
        return this.limit(async ()=>{
            ...
            try {
                ...
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$client$2f$lib$2d$esm$2f$hrana$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["resultSetFromHrana"])(hranaRowsResult);
            } catch (e) {
                throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$client$2f$lib$2d$esm$2f$hrana$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["mapHranaError"])(e);
            } finally{
    ...
    async batch(stmts, mode = "deferred") {
        return this.limit(async ()=>{
            ...
            try {
                ...
                const hranaStmts = normalizedStmts.map(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$client$2f$lib$2d$esm$2f$hrana$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["stmtToHrana"]);
    ...
    async migrate(stmts) {
        return this.limit(async ()=>{
            ...
            try {
                ...
                // network roundtrip.
                const batch = streamState.stream.batch(version >= 3);
                const resultsPromise = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$client$2f$lib$2d$esm$2f$hrana$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["executeHranaBatch"])("deferred", version, batch, hranaStmts, true);
                const results = await resultsPromise;
                return results;
            } catch (e) {
                throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$client$2f$lib$2d$esm$2f$hrana$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["mapHranaError"])(e);
    ...
    sync() {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$api$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LibsqlError"]("sync not supported in ws mode", "SYNC_NOT_SUPPORTED");
    }
    async #openStream() {
        if (this.closed) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$api$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LibsqlError"]("The client is closed", "CLIENT_CLOSED");
        }
        const now = new Date();
    ...
    #openConn(client) {
        try {
            client ??= __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$hrana$2d$client$2f$lib$2d$esm$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["openWs"](this.#url, this.#authToken);
            return {
                client,
...
;
function createClient(config) {
    return _createClient((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$config$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["expandConfig"])(config, true));
}
function _createClient(config) {
    if (config.scheme !== "https" && config.scheme !== "http") {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$api$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LibsqlError"]('The HTTP client supports only "libsql:", "https:" and "http:" URLs, ' + `got ${JSON.stringify(config.scheme + ":")}. For more information, please read ${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$util$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["supportedUrlLink"]}`, "URL_SCHEME_NOT_SUPPORTED");
    }
    if (config.encryptionKey !== undefined) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$api$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LibsqlError"]("Encryption key is not supported by the remote client.", "ENCRYPTION_KEY_NOT_SUPPORTED");
    }
    if (config.scheme === "http" && config.tls) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$api$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LibsqlError"](`A "http:" URL cannot opt into TLS by using ?tls=1`, "URL_INVALID");
    } else if (config.scheme === "https" && !config.tls) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$api$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LibsqlError"](`A "https:" URL cannot opt out of TLS by using ?tls=0`, "URL_INVALID");
    }
    const url = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$uri$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["encodeBaseUrl"])(config.scheme, config.authority, config.path);
...
class HttpClient {
    ...
    #remoteEncryptionKey;
    #promiseLimitFunction;
    /** @private */ constructor(url, authToken, intMode, customFetch, concurrency, remoteEncryptionKey){
        this.#url = url;
        this.#authToken = authToken;
        this.#intMode = intMode;
        ...
        this.#client = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$hrana$2d$client$2f$lib$2d$esm$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["openHttp"](this.#url, this.#authToken, this.#customFetch, remoteEncryptionKey);
        this.#client.intMode = this.#intMode;
        this.protocol = "http";
        this.#promiseLimitFunction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$promise$2d$limit$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"])(this.#concurrency);
    }
    async limit(fn) {
        return this.#promiseLimitFunction(fn);
    }
    async execute(stmtOrSql, args) {
        ...
        return this.limit(async ()=>{
            try {
                ...
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$client$2f$lib$2d$esm$2f$hrana$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["resultSetFromHrana"])(rowsResult);
            } catch (e) {
                throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$client$2f$lib$2d$esm$2f$hrana$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["mapHranaError"])(e);
            }
        });
    ...
    async migrate(stmts) {
        return this.limit(async ()=>{
            try {
                ...
                try {
                    const batch = stream.batch(false);
                    resultsPromise = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$client$2f$lib$2d$esm$2f$hrana$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["executeHranaBatch"])("deferred", version, batch, hranaStmts, true);
                } finally{
                    stream.closeGracefully();
                }
                const results = await resultsPromise;
    ...
    sync() {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$api$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LibsqlError"]("sync not supported in http mode", "SYNC_NOT_SUPPORTED");
    }
    close() {
        this.#client.close();
    }
    async reconnect() {
        try {
            ...
            this.#client = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$hrana$2d$client$2f$lib$2d$esm$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["openHttp"](this.#url, this.#authToken, this.#customFetch, this.#remoteEncryptionKey);
            this.#client.intMode = this.#intMode;
        }
    }
    get closed() {
...
function _createClient(config) {
    if (config.scheme === "ws" || config.scheme === "wss") {
        ...
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$api$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LibsqlError"]('The client that uses Web standard APIs supports only "libsql:", "wss:", "ws:", "https:" and "http:" URLs, ' + `got ${JSON.stringify(config.scheme + ":")}. For more information, please read ${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$core$2f$lib$2d$esm$2f$util$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["supportedUrlLink"]}`, "URL_SCHEME_NOT_SUPPORTED");
    }
}
}),
"[project]/node_modules/promise-limit/index.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
//# sourceMappingURL=node_modules_c17ec2c3._.js.map