(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/[root-of-the-server]__30df1af3._.js",
...
"[project]/lib/database.ts [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getDatabase() {
    if (!db) {
        ...
        db = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$libsql$2f$client$2f$lib$2d$esm$2f$web$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])({
            url,
            ...isFile ? {} : {
                authToken
            }
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/database.ts [middleware-edge] (ecmascript)");
;
;
;
const { handlers, signIn, signOut, auth } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])({
    ...
    callbacks: {
        async signIn ({ user }) {
            ...
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["upsertUser"])({
                    id: user.email,
                    email: user.email,
                    name: user.name || null,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__30df1af3._.js.map